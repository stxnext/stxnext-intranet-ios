...
- (void)viewDidDisappear:(BOOL)animated
{
    ...
    {
        [self.delegate textInputViewController:self didFinishWithResult:[self.inputTextView.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
    }
}
